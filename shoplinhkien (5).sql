...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2025 at 09:07 AM
...
(28, 4, 45, 2, NULL, 1, 0.00),
(29, 5, 45, 2, NULL, 10, 0.00),
(30, 5, 34, 2, NULL, 1, 0.00),
(31, 5, 32, 2, NULL, 2, 0.00),
(32, 5, 32, 1, NULL, 1, 0.00),
(33, 5, 31, 2, NULL, 1, 0.00);
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `chitietdonhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `chitietgiohang`
--
ALTER TABLE `chitietgiohang`
  MODIFY `chitietgiohangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `donhang`
  MODIFY `donhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
