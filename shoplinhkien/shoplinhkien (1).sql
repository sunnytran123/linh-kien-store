...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2025 at 02:13 PM
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `chitietdonhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `chitietgiohang`
--
ALTER TABLE `chitietgiohang`
  MODIFY `chitietgiohangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `donhang`
  MODIFY `donhangid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `khuyenmai`
  MODIFY `khuyenmaiid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
