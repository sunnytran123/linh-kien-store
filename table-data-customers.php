...
if(isset($_POST['id'])) {
    ...
    if(isset($_POST['action']) && $_POST['action'] == 'delete') {
        ...
        // Xóa người dùng có loại = 2 (khách hàng)
        $sql = "DELETE FROM nguoi_dung WHERE id = ? AND loai = 3";
...
$sql = "SELECT * FROM nguoi_dung WHERE loai = 3";
...
<p class="app-sidebar__user-name"><b><?php echo $_SESSION['ten_dang_nhap'];?></b></p>
    ...
    <ul class="app-menu">
        ...
        <?php endif; ?>
        <li><a class="app-menu__item active" href="table-data-customers.php"><i class='app-menu__icon bx bx-user-voice'></i><span
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                ...
                <?php
                    ...
                    echo "<tr><td colspan='10' class='text-center'>Không có khách hàng nào</td></tr>";
                }
                ?>
            </tbody>
            </table>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status === 'success') {
                        ...
                        swal("Thất bại!", "Không thể xóa khách hàng", "error");
                    }
                },
                error: function() {
...
$(document).ready(function() {
    ...
    $('#ModalUP form').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.status === 'success') {
                    swal("Thành công!", "Đã cập nhật thông tin khách hàng", "success")
                    .then(() => {
                        location.reload();
                    });
                } else {
